...
//            // procura primeiro nas mensagens novas
//            $scope.AllNewMessages.every(function (message) {
//                if (message.messageid === originalid && message.canReply === '') {
//                    NavigationService.showView('reply', message);
//                    return false;
//                }
//            });
//            // se nao achou nas novas, procura nas mensagens arquivadas
//            $scope.AllArchivedMessages.every(function (message) {
//                if (message.messageid === originalid && message.canReply === '') {
//                    NavigationService.showView('reply', message);
//                    return false;
//                }
